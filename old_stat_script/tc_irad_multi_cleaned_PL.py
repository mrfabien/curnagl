...
if year == '1991' or year == '1997' or year == '1999' or year == '2006':
    dew_point_xr_1 = xr.open_dataset('/work/FAC/FGSE/IDYST/tbeucler/default/raw_data/ECMWF/ERA5/PL/'+folder+'/'+var+'.nc')
    dew_point_xr_1 = dew_point_xr_1.sel(time=slice(year+'-01-01', year+'-03-31'))
    if year == '1991':
        next_year = '1992'
    elif year == '1997':
        next_year = '1998'
    ...
    dew_point_xr_2 = xr.open_dataset('/work/FAC/FGSE/IDYST/tbeucler/default/raw_data/ECMWF/ERA5/PL/'+folder+'/'+next_var+'.nc')
    dew_point_xr_2 = dew_point_xr_2.sel(time=slice(next_year+'-10-01', next_year+'-12-31'))
...
dew_point_xr = dew_point_xr.sel(level=level)
