...
config=/work/FAC/FGSE/IDYST/tbeucler/default/fabien/repos/curnagl/PL_variables/config_ML_to_SL_vert_2011.txt
...
python3 /work/FAC/FGSE/IDYST/tbeucler/default/fabien/repos/curnagl/PL_variables/tc_irad_multi_cleaned_PL_allyears_stats_v4.py "$nom_var" "$annee" "$level"

# Print to a file a message that includes the current $SLURM_ARRAY_TASK_ID, the same variable, and the year of the sample
echo "This is array task ${SLURM_ARRAY_TASK_ID}, the variable name is ${nom_var} and the year is ${annee}. Level is ${level}" >> /work/FAC/FGSE/IDYST/tbeucler/default/fabien/repos/curnagl/PL_variables/output_all.txt