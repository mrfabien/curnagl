...
if year == '1991' or year == '1997' or year == '1999' or year == '2006' or year == '2020' or year == '2021':
    if year == '2020' or year == '2021':
        dew_point_xr = xr.open_dataset('/work/FAC/FGSE/IDYST/tbeucler/default/raw_data/ECMWF/WS_fabien/missing_var/Temp_ERA5_'+year+'_'+folder+'.nc')
    else:
        ...
        if year == '1991':
            ...
            next_year = '2000'
            next_var = 'Temp_ERA5_' + next_year + '_' + folder
            dew_point_xr_22 = xr.open_dataset('/work/FAC/FGSE/IDYST/tbeucler/default/raw_data/ECMWF/WS_fabien/missing_var/'+next_var+'.nc')
